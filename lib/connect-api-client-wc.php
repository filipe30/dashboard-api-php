...
try {
	...
	$client = new WC_API_Client( 'http://ciaserver/t/trido.com.br/public/',
        'ck_3bf72f9187c318c9989ec33ae9104dbaad8d9e7f',
        'cs_8237b4b1ac925ddb1cdacd93ed9d5ed7eaa2593f', $options );

	// coupons
    //print_r($client->get('products'));
...
//	print_r( $client->coupons->get_count() );
	...
	//print_r( $client->products->create( array( 'title' => 'Capa do Batman', 'type' => 'simple', 'regular_price' => '9.99', 'description' => 'mais uma capa do batman' ) ) );
